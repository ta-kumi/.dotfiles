...
## vscode
alias e='code'
alias epl='code --list-extensions'
alias epa='code --install-extension'
alias epr='code --uninstall-extension'
alias ei='code-insiders'
alias eipl='code-insiders --list-extensions'
alias eipa='code-insiders --install-extension'
alias eipr='code-insiders --uninstall-extension'
## tmux
alias t='tmux'
alias tl='tmux ls'
alias tn='tmux new -s'
...
## go
alias g='go'
alias gn='go mod init'
alias gf='go fmt'
alias gc='go mod tidy && go vet'
alias gb='go build'
alias gx='go run .'
alias gpa='go add'
alias gpag='go install'
## node
alias n='npm'
alias nn='npm init'
